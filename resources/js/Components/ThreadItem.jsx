    ...
    <div
      ...
      <div className="border-b px-6 py-3">
        <div className="flex items-center justify-between gap-10">
          ...
          <div className="text-sm text-gray-700 flex items-center gap-1">{thread.created_at}</div>
        </div>
      </div>
      <div className="px-6 py-4">
        ...
        <Link
          ...
          className="text-gray-900 font-bold text-base hover:text-sky-500">
          {thread.title}
        </Link>
        <p className="line-clamp-2 text-sm mt-4">{thread.description}</p>
      </div>
